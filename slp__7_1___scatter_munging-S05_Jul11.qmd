...
```{r}
long_hypno_path <- 'Cache/Subject05/Jul11/S05_hypno_epochs_30s.csv'
long_spike_path <- 'Cache/Subject05/Jul11/S05_spike_epochs_30s.csv'
short_hypno_path <- 'Cache/Subject05/Jul11/S05_hypno_epochs_10s.csv'
short_spike_path <- 'Cache/Subject05/Jul11/S05_spike_epochs_10s.csv'
short_sw_path <- 'Cache/Subject05/Jul11/S05_sw_epochs_10s.csv'
sws_corr_path <- 'Cache/Subject05/Jul11/S05_sw_correlation.csv'
legui_path <- 'Cache/Subject05/S05_electrodes.csv'
long_out_path <- 'Cache/Subject05/Jul11/long_scatter.csv'
short_out_path <- 'Cache/Subject05/Jul11/short_scatter.csv'
