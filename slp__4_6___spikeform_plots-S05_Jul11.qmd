...
```{r}
form_path <- 'Cache/Subject05/Jul11/S05_spikeforms.csv'
log_path <- 'Cache/Subject05/Jul11/S05_logdensity_forms.csv'
plot_path <- 'Results/S05_Jul11_spikeforms_CLA_Left.svg'
plot_path_pixel <- 'Results/S05_Jul11_spikeforms_CLA_Left.png'
recording_length <- 9.68 # hours
selected_region <- 'CLA'
