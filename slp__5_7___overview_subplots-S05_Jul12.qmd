...
```{r}
sw_path <- 'Cache/Subject05/Jul12/S05_sw_epochs_10s.csv'
spike_path <- 'Cache/Subject05/Jul12/S05_spike_epochs_10s.csv'
spike_pca_path <- 'Cache/Subject05/Jul12/S05_pca_10s_epochs.csv'
swa_rds_path <- 'Cache/Subject05/Jul12/S05_SWA.RDS'
beta_rds_path <- 'Cache/Subject05/Jul12/S05_Beta.RDS'
sw_rds_path <- 'Cache/Subject05/Jul12/S05_SW.RDS'
spike_rds_path <- 'Cache/Subject05/Jul12/S05_spikes_right.RDS'
cspike_rds_path <- 'Cache/Subject05/Jul12/S05_color_spikes_right.RDS'
pca_rds_path <- 'Cache/Subject05/Jul12/S05_pca_spikes_right.RDS'
