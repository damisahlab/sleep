...
heatmap_input <- 'Cache/Subject01/Feb02/S01_STA_heatmap.csv'
roseplot_input <- 'Cache/Subject01/Feb02/S01_STA_roseplot.csv'
unit_response_input <- 'Cache/Subject01/Feb02/S01_unit_response.csv'

# Comment out the "filter(response_type == 'Positive')" when doing all units
heatmap_output <- 'Results/S01_MI_heatmap_bursters.svg'
roseplot_output <- 'Results/S01_STA_roseplot_bursters.svg'

width = 6
height = 3 # 6 for all units; 3 for bursters
