...
```{r}
data <- read.csv('Cache/Subject05/Jul13/S05_event_epochs.csv')

sw_facet_path <- 'Results/S05_Jul13_sw_facet.svg'
kc_facet_path <- 'Results/S05_Jul13_kc_facet.svg'

sw_wave_path <- 'Results/S05_Jul13_sw_waveform.svg'
kc_wave_path <- 'Results/S05_Jul13_kc_waveform.svg'

sw_rds_path <- 'Cache/Subject05/Jul13/sw_waveform.RDS'
```
