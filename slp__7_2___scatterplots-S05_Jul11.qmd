...
```{r}
long_scatter_path <- 'Cache/Subject05/Jul11/long_scatter.csv'
short_scatter_path <- 'Cache/Subject05/Jul11/short_scatter.csv'
stage_single_out_path <- 'Results/S05_Jul11_FR_stage_single.svg'
sws_single_out_path <- 'Results/S05_Jul11_FR_SWS_single.svg'
swa_single_out_path <- 'Results/S05_Jul11_FR_SWA_single.svg'
beta_single_out_path <- 'Results/S05_Jul11_FR_Beta_single.svg'
