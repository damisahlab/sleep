...
avEEG_path <- 'Data/Subject05/S05_avEEG_Jul13.xlsx'
rds_path <- 'Cache/Subject05/Jul13/S05_hypnogram.RDS'
output_path <- 'Results/S05_Jul13_hypnogram.svg'
start_time <- as_datetime("2023-07-13 21:01:00")
stop_time <- as_datetime("2023-07-14 07:25:00")
sampling_freq = 256
```
