...
```{r}
hyp_path <- 'Cache/Subject05/Jul12/S05_hyp_correlation.csv'
swa_path <- 'Cache/Subject05/Jul12/S05_swa_correlation_10s.csv'
sw_path <- 'Cache/Subject05/Jul12/S05_sw_correlation_10s.csv'

sw_heatmap_out_path <- 'Cache/Subject05/Jul12/S05_unit_heatmap_sw.csv'
swa_heatmap_out_path <- 'Cache/Subject05/Jul12/S05_unit_heatmap_swa.csv'
response_out_path <- 'Cache/Subject05/Jul12/S05_unit_response.csv'
```
