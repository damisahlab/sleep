...
```{r}
long_scatter_path <- 'Cache/Subject01/Feb02/long_scatter.csv'
short_scatter_path <- 'Cache/Subject01/Feb02/short_scatter.csv'
stage_single_out_path <- 'Results/S01_FR_stage_single.svg'
sws_single_out_path <- 'Results/S01_FR_SWS_single.svg'
swa_single_out_path <- 'Results/S01_FR_SWA_single.svg'
beta_single_out_path <- 'Results/S01_FR_Beta_single.svg'
