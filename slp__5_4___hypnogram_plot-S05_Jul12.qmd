...
avEEG_path <- 'Data/Subject05/S05_avEEG_Jul12.xlsx'
rds_path <- 'Cache/Subject05/Jul12/S05_hypnogram.RDS'
output_path <- 'Results/S05_Jul12_hypnogram.svg'
start_time <- as_datetime("2023-07-12 21:22:51")
stop_time <- as_datetime("2023-07-13 07:55:41")
sampling_freq = 256
```
