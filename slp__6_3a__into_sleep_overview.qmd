...
```{r}
spectro_path <- 'Cache/Subject01/S01_spectro_t5760.csv'
spike_path <- 'Cache/Subject01/S01_spike_t5760.csv'

spectro_rds_out <- 'Cache/Subject01/S01_spectro_t5760.RDS'
spike_rds_out <- 'Cache/Subject01/S01_zspike_t5760.RDS'

#S01-1: 1920 +/- 340 (zoom 1700, 2140 +/- 15), y_limits = c(-0.75, 0.75)
#S01-3: 4140 +/- 480 (zoom 3840, 4440 +/- 15), y_limits = c(-0.10, 0.10)
