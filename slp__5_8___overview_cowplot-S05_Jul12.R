...
# Parameters
hypno <- readRDS('Cache/Subject05/Jul12/S05_hypnogram.RDS')
scalp <- readRDS('Cache/Subject05/Jul12/S05_scalp_spectrogram.RDS')
iceeg <- readRDS('Cache/Subject05/Jul12/S05_iceeg_spectrogram.RDS')
swa <- readRDS('Cache/Subject05/Jul12/S05_SWA.RDS')
sw <- readRDS('Cache/Subject05/Jul12/S05_SW.RDS')
cspikes <- readRDS('Cache/Subject05/Jul12/S05_color_spikes_right.RDS')
pca <- readRDS('Cache/Subject05/Jul12/S05_pca_spikes_right.RDS')
output_path <- 'Results/S05_Jul12_overview_plot.svg'
hypno_legend_path <- 'Results/S05_Jul12_hypno_legend.svg'
scalp_legend_path <- 'Results/S05_Jul12_scalp_legend.svg'
iceeg_legend_path <- 'Results/S05_Jul12_iceeg_legend.svg'
swa_legend_path <- 'Results/S05_Jul12_swa_legend.svg'
sw_legend_path <- 'Results/S05_Jul12_sw_legend.svg'
cspikes_legend_path <- 'Results/S05_Jul12_cspikes_legend.svg'
pca_legend_path <- 'Results/S05_Jul12_pca_legend.svg'
