...
```{r}
heatmap_input_path <- 'Cache/Subject05/Jul11/S05_unit_heatmap_swa.csv'
barplot_input_path <- 'Cache/Subject05/Jul11/S05_unit_response.csv'

heatmap_output_path <- 'Results/S05_Jul11_response_heatmap.svg'
barplot_output_path <- 'Results/S05_Jul11_response_barplot.svg'
```
...
color_map <- colorRamp2(c(-0.5, 0, 0.5), c('#6A89D4', 'white', '#D46A6A'))
