...
```{r}
spectro_path <- 'Cache/Subject05/Jul11/S05_spectro_t11700.csv'
spike_path <- 'Cache/Subject05/Jul11/S05_spike_t11700.csv'

spectro_rds_out <- 'Cache/Subject05/Jul11/S05_spectro_t11700.RDS'
spike_rds_out <- 'Cache/Subject05/Jul11/S05_zspike_t11700.RDS'
```
...
zoom_tpoint_1 = tpoint - 180
zoom_window_1 = 15

zoom_tpoint_2 = tpoint + 180
zoom_window_2 = 15
