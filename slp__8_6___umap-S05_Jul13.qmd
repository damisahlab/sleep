...
```{r}
spike_epoch_path <- 'Cache/Subject05/Jul13/S05_spike_epochs_10s.csv'
sw_corr_path <- 'Cache/Subject05/Jul13/S05_sw_correlation_10s.csv'
swa_corr_path <- 'Cache/Subject05/Jul13/S05_swa_correlation_10s.csv'
umap_groups_path <- 'Cache/Subject05/Jul13/S05_UMAP_Groups_10s.csv'

spike_plot_path <- 'Results/S05_Jul13_UMAP_spike_10s_epochs.svg'
sw_plot_path <- 'Results/S05_Jul13_UMAP_sw_10s_epochs.svg'
swa_plot_path <- 'Results/S05_Jul13_UMAP_swa_10s_epochs.svg'
