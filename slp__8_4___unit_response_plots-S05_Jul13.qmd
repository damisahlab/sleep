...
```{r}
heatmap_input_path <- 'Cache/Subject05/Jul13/S05_unit_heatmap_swa.csv'
barplot_input_path <- 'Cache/Subject05/Jul13/S05_unit_response.csv'

heatmap_output_path <- 'Results/S05_Jul13_response_heatmap.svg'
barplot_output_path <- 'Results/S05_Jul13_response_barplot.svg'
```
