...
```{r}
hypno_path <- 'Cache/Subject05/Jul11/S05_Jul11_hypnogram.csv'
avEEG_path <- 'Data/Subject05/S05_avEEG_Jul11.xlsx'
rds_path <- 'Cache/Subject05/Jul11/S05_hypnogram.RDS'
output_path <- 'Results/S05_Jul11_hypnogram.svg'
start_time <- as_datetime("2023-07-11 22:24:20")
stop_time <- as_datetime("2023-07-12 08:05:10")
sampling_freq = 256
```
