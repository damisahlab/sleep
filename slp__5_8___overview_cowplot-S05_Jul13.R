...
# Parameters
hypno <- readRDS('Cache/Subject05/Jul13/S05_hypnogram.RDS')
scalp <- readRDS('Cache/Subject05/Jul13/S05_scalp_spectrogram.RDS')
iceeg <- readRDS('Cache/Subject05/Jul13/S05_iceeg_spectrogram.RDS')
swa <- readRDS('Cache/Subject05/Jul13/S05_SWA.RDS')
sw <- readRDS('Cache/Subject05/Jul13/S05_SW.RDS')
cspikes <- readRDS('Cache/Subject05/Jul13/S05_color_spikes_right.RDS')
pca <- readRDS('Cache/Subject05/Jul13/S05_pca_spikes_right.RDS')
