...
# Parameters
hypno <- readRDS('Cache/Subject01/Feb02/S01_hypnogram.RDS')
scalp <- readRDS('Cache/Subject01/Feb02/S01_scalp_spectrogram.RDS')
iceeg <- readRDS('Cache/Subject01/Feb02/S01_iceeg_spectrogram.RDS')
swa <- readRDS('Cache/Subject01/Feb02/S01_SWA.RDS')
sw <- readRDS('Cache/Subject01/Feb02/S01_SW.RDS')
cspikes <- readRDS('Cache/Subject01/Feb02/S01_color_spikes_right.RDS')
pca <- readRDS('Cache/Subject01/Feb02/S01_pca_spikes_right.RDS')
output_path <- 'Results/S01_overview_plot.svg'
hypno_legend_path <- 'Results/S01_hypno_legend.svg'
scalp_legend_path <- 'Results/S01_scalp_legend.svg'
iceeg_legend_path <- 'Results/S01_iceeg_legend.svg'
swa_legend_path <- 'Results/S01_swa_legend.svg'
sw_legend_path <- 'Results/S01_sw_legend.svg'
cspikes_legend_path <- 'Results/S01_cspikes_legend.svg'
pca_legend_path <- 'Results/S01_pca_legend.svg'
