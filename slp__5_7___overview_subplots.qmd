...
```{r}
sw_path <- 'Cache/Subject01/Feb02/S01_sw_epochs_10s.csv'
spike_path <- 'Cache/Subject01/Feb02/S01_spike_epochs_10s.csv'
spike_pca_path <- 'Cache/Subject01/Feb02/S01_pca_10s_epochs.csv'
swa_rds_path <- 'Cache/Subject01/Feb02/S01_SWA.RDS'
beta_rds_path <- 'Cache/Subject01/Feb02/S01_Beta.RDS'
sw_rds_path <- 'Cache/Subject01/Feb02/S01_SW.RDS'
spike_rds_path <- 'Cache/Subject01/Feb02/S01_spikes.RDS'
cspike_rds_path <- 'Cache/Subject01/Feb02/S01_color_spikes.RDS'
pca_rds_path <- 'Cache/Subject01/Feb02/S01_pca_spikes.RDS'
