...
sw_corr_path <- 'Cache/Subject01/Feb02/S01_sw_correlation_10s.csv'
swa_corr_path <- 'Cache/Subject01/Feb02/S01_swa_correlation_10s.csv'
umap_groups_path <- 'Cache/Subject01/Feb02/S01_UMAP_Groups_10s.csv'

spike_plot_path <- 'Results/S01_UMAP_spike_10s_epochs.svg'
sw_plot_path <- 'Results/S01_UMAP_sw_10s_epochs.svg'
swa_plot_path <- 'Results/S01_UMAP_swa_10s_epochs.svg'

unit_regions <- c('CLA', 'ACC', 'AMY')
unit_colors <- c('#E28DB8', '#A67A77', '#7BA387')
#unit_colors <- c('#e8a2c5', '#805553', '#7da58a')
```
