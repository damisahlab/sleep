...
heatmap_input <- 'Cache/Subject05/Jul11/S05_STA_heatmap.csv'
roseplot_input <- 'Cache/Subject05/Jul11/S05_STA_roseplot.csv'
unit_response_input <- 'Cache/Subject05/Jul11/S05_unit_response.csv'

# Comment out the "filter(response_type == 'Positive')" when doing all units
heatmap_output <- 'Results/S05_Jul11_MI_heatmap_bursters.svg'
roseplot_output <- 'Results/S05_Jul11_STA_roseplot_bursters.svg'

width = 5
height = 2.2 # 6 for all units; 2.2 for bursters
